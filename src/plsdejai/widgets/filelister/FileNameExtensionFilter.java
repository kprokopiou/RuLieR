...
/**
 * An implementation of {@code java.io.FileFilter} that filters using a
...
public final class FileNameExtensionFilter implements java.io.FileFilter {
    ...
    private boolean isAcceptAllFilter = false;
    ...
    public FileNameExtensionFilter(String description, String... extensions) {
        if (extensions == null || extensions.length == 0) {
            isAcceptAllFilter = true;
            this.description = "All";
            this.extensions = new String[]{};
            this.lowerCaseExtensions = new String[]{};
            return;
        }
    ...
    public static FileNameExtensionFilter getAcceptAllFilter()
    {
       return new FileNameExtensionFilter(null, (String []) null);
    }
    ...
    public boolean isSupportedExtension(String e)
    {
       if (isAcceptAllFilter)
          return true;
